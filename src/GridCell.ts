...
export default class GridCell {
  ...
  //   const x: cellX = Math.floor(coordinateConversion.getReferenceX(event.clientX) / Cell.referenceCellSize);
  //   const y: cellY = Math.floor(coordinateConversion.getReferenceY(event.clientY) / Cell.referenceCellSize);
// 
  //   console.log(x, y);
// 
  //   this.draw(ctx);
